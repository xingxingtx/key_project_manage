...
//        return encoder.encode(outputStream.toByteArray());// 返回Base64编码过的字节数组字符串
   ...
   /* public static void main(String[] arg)throws ParseException{
    ...
    public static String[] getDepartment(){
        return new String[]{
                "市公安局", "市中级人民法院", "市人民检察院",
                "市公安局鹤城分局", "市国土资源管理局", "市住建局",
                "市信访局", "市人社局", "市发改委", "市司法局",
                "市政府督查办", "市征收办", "市征收安置办", "市城建投",
                "市建设投", "市水务投", "市交建投", "市政府督查室",
                "市政府办", "市纪委监察委", "市宣传部",
                "市铁路协调指挥部", "市重点项目管理办公室",
                "市纪委", "区县公安局", "区县中级人民法院",
                "区县人民检察院", "区县公安局鹤城分局",
                "区县国土资源管理局", "区县住建局", "区县信访局",
                "区县人社局", "区县发改委", "区县司法局",
                "区县政府督查办", "区县征收办", "区县征收安置办", "区县城建投",
                "区县建设投", "区县水务投", "区县交建投",
                "区县政府督查室", "区县政府办", "区县纪委监察委",
                "区县宣传部", "区县铁路协调指挥部", "区县重点项目管理办公室",
                "区县纪委"
        };
    }
